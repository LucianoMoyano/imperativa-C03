...
function elements (arreglo, propiedad){
    ...
    let nuevoArreglo = []
    //se pasa a recorrer el arreglo ecommerce, en donde se instancia una inicialización, condicion e incremento
    for(let i = 0; i < arreglo.length; i++){
        //utilizamos el metodo .push() para ir guardando cada uno de los valores dentro de la nueva variable llamada nuevoArreglo
